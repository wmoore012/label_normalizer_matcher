...
try:
    from .benchmarks import BenchmarkResult, LabelNormalizerBenchmark, generate_realistic_labels

    __all__ += ["LabelNormalizerBenchmark", "BenchmarkResult", "generate_realistic_labels"]
